...
public class UserController {
    ...
    public ResponseEntity getAllUsers() {
        User user1 = new User(UUID.randomUUID(), "user1", Role.ADMIN, new Credentials("user1@aabc.com", "password"));
        User user2 = new User(UUID.randomUUID(), "user2", Role.REGULAR, new Credentials("user2@aabc.com", "password2"));
    ...
    public ResponseEntity getUser(@PathVariable String username) {
        User user1 = new User(UUID.randomUUID(), "user1", Role.ADMIN, new Credentials(username, "password"));
